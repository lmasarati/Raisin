...
my @HOOKS_METHODS = qw(before before_validation failed_validation after_validation after); # lmasarati
...
sub failed_validation { app->add_hook('failed_validation', shift) } # lmasarati
